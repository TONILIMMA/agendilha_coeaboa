    ...
    <main className="min-h-screen px-4 py-8 max-w-lg mx-auto">
      ...
      <form onSubmit={submit} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <Input id="responsavelNome" className="h-12 text-base" value={form.responsavelNome} onChange={(e) => set("responsavelNome", e.target.value)} placeholder="Quem responde pelo atrativo" />
        </div>
