        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center animate-fade-in">
          ...
          <div className="mt-10 flex flex-col xs:flex-row items-stretch xs:items-center justify-center gap-2.5 w-full xs:w-auto">
            <Link to="/coeaboa" className="w-full xs:w-auto">
              <Button size="lg" className="w-full rounded-full h-12 px-7 bg-primary text-primary-foreground hover:bg-primary/90 shadow-elevated">
                Ver agenda <ArrowRight className="ml-1 h-4 w-4" />
              </Button>
            </Link>
            <Link to="/auth" className="w-full xs:w-auto">
              <Button size="lg" variant="ghost" className="w-full rounded-full h-12 px-7 text-foreground/80 hover:bg-white/60">
                Cadastrar evento
              </Button>
            </Link>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[2rem] gradient-eco-deep text-primary-foreground p-10 sm:p-16 grain">
            ...
            <div className="relative flex flex-col lg:flex-row items-start lg:items-end gap-10 justify-between">
              ...
              <div className="flex flex-wrap gap-2.5 shrink-0">
                <Link to="/coeaboa">
                  <Button className="rounded-full h-12 px-6 bg-background text-foreground hover:bg-background/90">
                    <FileDown className="h-4 w-4 mr-1.5" />
                    Baixar PDF
                  </Button>
                </Link>
                <Link to="/agenda">
                  <Button variant="outline" className="rounded-full h-12 px-6 bg-transparent border-white/25 text-primary-foreground hover:bg-white/10 hover:text-primary-foreground">
                    Ver agenda completa
                  </Button>
                </Link>
              </div>
