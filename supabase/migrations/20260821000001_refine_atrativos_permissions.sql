...
CREATE POLICY "atrativos_update_authorized_v2"
ON public.atrativos
FOR UPDATE
TO authenticated
USING (
...
-- The owner/responsavel usually cannot delete a curated record without admin intervention in this system's logic,
-- but we follow the prompt's instructions: "Excluir: administrador, mestre ou colaborador com can_delete."
CREATE POLICY "atrativos_delete_authorized_v2"
ON public.atrativos
FOR DELETE
TO authenticated
USING (
