-- 1. Painel admin: exige admin/master dentro da função
...
-- 2. Funções de gatilho não devem ser chamáveis pela API
REVOKE EXECUTE ON FUNCTION public.notify_admins_on_change_request() FROM anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.notify_admins_on_divulgador_request() FROM anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.apply_divulgador_request_approval() FROM anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.log_profile_phone_change() FROM anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.prevent_user_type_self_escalation() FROM anon, authenticated;

-- 3. Dados internos e checagens de papel: somente usuários logados
REVOKE EXECUTE ON FUNCTION public.get_atrativo_internal(uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.get_estabelecimento_internal(uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.is_admin_or_master(uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.is_promotor(uuid) FROM anon;